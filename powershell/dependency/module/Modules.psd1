@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '16.2.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.8.4' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'Pester' ; Version = '6.1.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
