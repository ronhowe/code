@{
    Modules = @(
        ...
        @{ Name = 'Az' ; Version = '16.3.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        # https://dbatools.io
        @{ Name = 'dbatools' ; Version = '2.9.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
        ...
        @{ Name = 'ModuleBuilder' ; Version = '3.2.18' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },

        # https://oneget.org/
        @{ Name = 'PackageManagement' ; Version = '1.4.8.1' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },

        # https://github.com/pester/Pester
        @{ Name = 'Pester' ; Version = '6.2.0' ; Repository = 'PSGallery' ; CompatiblePSEditions = @('Core', 'Desktop') },
